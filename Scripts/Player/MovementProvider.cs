...
public class MovementProvider : LocomotionProvider
{
    ...
    private void PositionController() {
        ...
        float headHeight = Mathf.Clamp(head.transform.localPosition.y, 1, 2); // Calmping height between 1 and 2 meters
    ...
    private void ApplyGravity() {
        Vector3 gravity = new Vector3(0, Physics.gravity.y * gravityMultiplyer, 0);
